...
class PersonResourceIT {
    ...
    public static Person createEntity(EntityManager em) {
        Person person = new Person().name(DEFAULT_NAME).surname(DEFAULT_SURNAME).gender(DEFAULT_GENDER);
        return person;
    }
    ...
    public static Person createUpdatedEntity(EntityManager em) {
        Person person = new Person().name(UPDATED_NAME).surname(UPDATED_SURNAME).gender(UPDATED_GENDER);
        return person;
    }
    ...
    void putExistingPerson() throws Exception {
        ...
        updatedPerson.name(UPDATED_NAME).surname(UPDATED_SURNAME).gender(UPDATED_GENDER);
    ...
    void fullUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.name(UPDATED_NAME).surname(UPDATED_SURNAME).gender(UPDATED_GENDER);
